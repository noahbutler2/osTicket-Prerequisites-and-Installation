...
<p>
Now that you are connected to your VM you will have to enable IIS(Internet Information Services). Simply access the control panel then select uninstall a program. Off to the left select "Turn windows features on or off". A list will appear then you will enable Internet Information Services.
</p>  
